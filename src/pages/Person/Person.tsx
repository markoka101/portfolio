...
import FadeInImage from '../../components/ui/FadeInImage/FadeInImage';
				...
				<article className="container mx-auto mt-12 mb-12 flex min-h-[65vh] w-11/12 flex-col items-center rounded-xl border-4 bg-black/70 px-10 py-10 sm:mt-28 md:mt-28 md:flex-row lg:mt-28">
					<div className="mb-16 flex flex-col items-center text-center md:mb-0 md:w-1/2 md:items-start md:pr-16 md:text-left lg:flex-grow lg:pr-24">
						...
						<p className="mb-4 text-left leading-relaxed text-gray-200">
							I was born in Sao Paulo and moved to New York shortly after I was born.
							I have dual citizenship of Brazil and the United States. I come from a
							very diverse background where my paternal grandparents are from Japan
							and Texas. I also have three cats named Throatcuttah, Hades, and Salem.
						</p>
						...
						<p className="text-left leading-relaxed text-gray-200">
							...
							<br />
							-I have an extensive collection of board games and organize game nights{' '}
							<br />
							-I love traveling. Some of the places I've visited include Kenya, Japan,
							England, and Costa Rica <br />
							-I spend a lot of time helping others with home improvement projects{' '}
							<br />
