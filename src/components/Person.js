...
export default function Person(){
    return (
        <section id="person" className="relative bg-gray-900">
          <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              ...
              <p className="leading-relaxed text-gray-300">
                ...
                -I love traveling. Some of the places I've visited include Kenya, Japan, England, and Costa Rica <br/>
                -I spend a lot of time helping my family with home improvement projects <br/>
                -I am passionate about aviation and as a kid, I wanted to be a pilot
              </p>
            </div>
            <div className="sm:max-w-sm lg:w-full md:w-1/2 w-5/6">
              <p className="mb-1 leading-relaxed text-gray300">
                Top Left: Hades <br/>
